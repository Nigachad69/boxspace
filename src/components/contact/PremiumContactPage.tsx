    ...
    <section className="relative py-24 md:py-32 bg-background text-foreground overflow-hidden">
      ...
      >
        ...
        <motion.div className="mt-24" variants={fadeInUp}>
            <h3 className="text-2xl font-bold text-foreground mb-6 text-center">Our Location</h3>
            <div className="bg-card/50 backdrop-blur-sm rounded-xl border border-border p-2">
                <iframe
                    src="https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=19.19167379206832,72.96945904141039"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
